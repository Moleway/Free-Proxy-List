...
**Current LIVE endpoints:** **1998**

| List | Contents | Current count |
| --- | --- | ---: |
| [`all.txt`](https://raw.githubusercontent.com/Moleway/Free-Proxy-List/main/all.txt) | All LIVE proxies with protocol prefix | 1998 |
| [`http.txt`](https://raw.githubusercontent.com/Moleway/Free-Proxy-List/main/http.txt) | LIVE HTTP proxies | 1326 |
| [`https.txt`](https://raw.githubusercontent.com/Moleway/Free-Proxy-List/main/https.txt) | LIVE HTTP proxies verified to support HTTPS tunnelling | 444 |
| [`socks4.txt`](https://raw.githubusercontent.com/Moleway/Free-Proxy-List/main/socks4.txt) | LIVE SOCKS4 proxies | 245 |
| [`socks5.txt`](https://raw.githubusercontent.com/Moleway/Free-Proxy-List/main/socks5.txt) | LIVE SOCKS5 proxies | 430 |
