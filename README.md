...
**Current LIVE endpoints:** **1395**

| List | Contents | Current count |
| --- | --- | ---: |
| [`all.txt`](https://raw.githubusercontent.com/Moleway/Free-Proxy-List/main/all.txt) | All LIVE proxies with protocol prefix | 1395 |
| [`http.txt`](https://raw.githubusercontent.com/Moleway/Free-Proxy-List/main/http.txt) | LIVE HTTP proxies | 758 |
| [`https.txt`](https://raw.githubusercontent.com/Moleway/Free-Proxy-List/main/https.txt) | LIVE HTTP proxies verified to support HTTPS tunnelling | 186 |
| [`socks4.txt`](https://raw.githubusercontent.com/Moleway/Free-Proxy-List/main/socks4.txt) | LIVE SOCKS4 proxies | 207 |
