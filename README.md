...
**Current LIVE endpoints:** **1585**

| List | Contents | Current count |
| --- | --- | ---: |
| [`all.txt`](https://raw.githubusercontent.com/Moleway/Free-Proxy-List/main/all.txt) | All LIVE proxies with protocol prefix | 1585 |
| [`http.txt`](https://raw.githubusercontent.com/Moleway/Free-Proxy-List/main/http.txt) | LIVE HTTP proxies | 876 |
| [`https.txt`](https://raw.githubusercontent.com/Moleway/Free-Proxy-List/main/https.txt) | LIVE HTTP proxies verified to support HTTPS tunnelling | 238 |
| [`socks4.txt`](https://raw.githubusercontent.com/Moleway/Free-Proxy-List/main/socks4.txt) | LIVE SOCKS4 proxies | 253 |
| [`socks5.txt`](https://raw.githubusercontent.com/Moleway/Free-Proxy-List/main/socks5.txt) | LIVE SOCKS5 proxies | 459 |
